...
export const BtnData = [
  {
    ...
    description:
      "The Cannes Festival <i> (Festival de Cannes) </i>, until 2003 called the International Film Festival and known in English as the Cannes Film Festival, is an annual film festival held in Cannes, France, which previews new films of all genres, including documentaries, from all around the world. Founded in 1946, the invitation-only festival is held annually (usually in May) at the Palais des Festivals et des Congrès. ",
    arr: [
      {
  ...
  },
  {
    ...
    description:
      "The Taipei Golden Horse Film Festival and Awards <i> (台北金馬影展) </i> is a film festival and awards ceremony held annually in Taiwan. It was founded in 1962 by the Government Information Office of the Republic of China (ROC) in Taiwan. The awards ceremony is usually held in November or December in Taipei, although the event has also been held in other locations in Taiwan in recent times.",
    arr: [
      {
        subBtnValue: "best_film",
        subBtnText: "Best Film",
  ...
  },
  {
    ...
    description:
      'The Berlin International Film Festival <i> (Internationale Filmfestspiele Berlin) </i>, usually called the Berlinale, is a film festival held annually in Berlin, Germany. Founded in West Berlin in 1951, the festival has been held every February since 1978 and is one of the "Big Three" alongside the Venice Film Festival in Italy and the Cannes Film Festival in France.',
    arr: [
      {
